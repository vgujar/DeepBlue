...
<title>Star Rating System for NGOS</title>
...
<body onload="showRestaurantData('getRatingData.php')">
    ...
    <button style="margin: 1%" class="btn btn-success" type="submit" value="HOME" name='home' color="green " onclick="document.location.href = '/cpt/buttons%20(1).html'">HOME</button>

    <div class="container">
        <h2>Star Rating System FOR NGOS</h2>
